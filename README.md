...
<!-- 헤더 배너 -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:667eea,100:764ba2&height=220&section=header&text=Hyeonseung%20Jeong&fontSize=60&fontColor=ffffff&fontAlignY=38&desc=Frontend%20Developer&descAlignY=58&descSize=20&animation=fadeIn" width="100%" />
...
const developer = {
  ...
  currentlyLearning: ["Next.js", "Python"],
};
```
...
| :---: | :---: |
| **정보처리기사** | 한국산업인력공단 |
| **삼성전자 S/W 역량테스트 A형** | Samsung Electronics |
